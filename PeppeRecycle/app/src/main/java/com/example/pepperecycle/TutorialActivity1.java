...
public class TutorialActivity1 extends RobotActivity implements RobotLifecycleCallbacks, View.OnTouchListener {
...
//        mCurrentPage
    ...
    public void nextTurn() { // Avvia la activity relativa al prossimo turno
        Intent activity2Intent = new Intent(TutorialActivity1.this, TutorialActivity2.class);
        activity2Intent.putExtra("tutorialEnabled", tutorialEnabled);
        activity2Intent.putExtra("round", 0);
        activity2Intent.putExtra("pepperScore", false);
        activity2Intent.putExtra("userScore", 0);
